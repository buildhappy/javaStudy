...
public class ChannelsDom {
	...
	public ChannelsDom(){
		logger.info("com.buildhappy.dom.ChannelsDom no-parameter constructor");
	}
	public ChannelsDom(String channelId){
		logger.info("com.buildhappy.dom.ChannelsDom constructor with parameter channelId");
		this.channelId = channelId;
		load();
	}
	public ChannelsDom createChannelsDom(String channelId){
		logger.info("com.buildhappy.dom.ChannelsDom createChannelsDom(String channelId)");
		this.channelId = channelId;
	...
	public int load(){
		logger.info("com.buildhappy.dom.ChannelsDom load()");
		try {
			// 将待抓取的网站信息存在xml文件中
